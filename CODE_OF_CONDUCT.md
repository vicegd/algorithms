...
## ✅ Expected Behavior (The "Do's")
* **Be Respectful:** Treat everyone with kindness and professional courtesy, regardless of their experience level.
* **Be Patient:** Remember that everyone starts somewhere. If someone makes a beginner mistake in a Pull Request, guide them constructively.
* **Focus on Education:** When reviewing code or answering issues, explain the *why* behind your suggestions. 
* **Welcome Questions:** There are no stupid questions when learning computer science.

## ❌ Unacceptable Behavior (The "Don'ts")
* **Gatekeeping or Elitism:** Avoid condescending language (e.g., "RTFM" or "this is trivial"). 
