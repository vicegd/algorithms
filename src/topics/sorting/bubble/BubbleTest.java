...
/**
 * <h1>Validation Suite for Bubble Sort</h1>
 * <p>
 * Verifies the mathematical correctness and in-place stability of the 
 * Bubble Sort implementation across different array configurations.
 * </p>
 *
 * @author vicegd
 */
class BubbleTest {
    ...
    void shouldSortSmallMixedSequence() {
        ...
        // assertArrayEquals natively checks length and element-by-element equality, 
        // replacing the need for manual for-loops in test code.
        assertArrayEquals(expected, elements, "The sequence failed to sort correctly.");
    }
    ...
    void shouldSortLargerVariedSequence() {
        ...
        assertArrayEquals(expected, elements, "The larger sequence failed to sort correctly.");
    }
}