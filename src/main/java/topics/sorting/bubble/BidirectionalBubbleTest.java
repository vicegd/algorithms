...
/**
 * <h1>Validation Suite for Bidirectional Bubble Sort</h1>
 * <p>
 * Verifies the alternating forward and backward sweeps, ensuring 
 * the mathematical accuracy and in-place stability of the algorithm.
 * </p>
 *
 * @author vicegd
 */
class BidirectionalBubbleTest {
    ...
    @BeforeAll
    static void setup() {
        sorting = new BidirectionalBubble();
    }
    ...
    void shouldSortSmallMixedSequence() {
        ...
        assertArrayEquals(expected, elements, "The sequence failed to sort correctly via bidirectional sweeps.");
    }
