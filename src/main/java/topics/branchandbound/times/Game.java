...
/**
 * Branch and Bound node representing a board state for the rectangle placement problem.
 *
 * Each Game instance holds a snapshot of the board and the list of pieces still to place.
 * New children are generated by {@code expand()}, which tries every valid position and
 * orientation for the next unplaced piece.
 *
 * @author vicegd
