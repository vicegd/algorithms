...
/**
 * <h1>Validation Suite for Direct Insertion Sort</h1>
 * <p>
 * Verifies the shifting logic, structural integrity, and in-place 
 * stability of the Direct Insertion Sort algorithm using JUnit 5.
 * </p>
 *
 * @author vicegd
 */
class DirectInsertionTest {
    ...
    void shouldSortSmallMixedSequence() {
        ...
        assertArrayEquals(expected, elements, "The sequence failed to shift and sort correctly.");
    }
    ...
    void shouldSortLargerVariedSequence() {
        ...
        assertArrayEquals(expected, elements, "The larger sequence failed to shift and sort correctly.");
    }
}